...
create table ranking (
	...
	constraint fk_ranking_warriorname foreign key (warrior_name) references warriors (warrior_name),
    constraint fk_ranking_weaponname foreign key (weapon_name) references weapons (weapon_name)
);
